...
class Calculator:
    def __init__(self, master):
        ...
        for text, command in buttons:
            ...
            button = tk.Button(master, text=text, padx=2, pady=2, command=command, font=("Segoe UI Black", 18), bg=button_bg, fg=button_fg, relief='ridge', activebackground="#DCDCDC", activeforeground="#030303", zeros_confusion)
    ...
    def zeros_confusion(self, event):
