...
class Calculator:
    def __init__(self, master):
        ...
        buttons = [
            ...
            ("7", self.append("7")), ("8", self.append("8")), ("9", self.append("9")), ("×", lambda: self.append("*")),
            ("4", self.append("4")), ("5", self.append("5")), ("6", self.append("6")), ("-", lambda: self.append("-")),
            ("1", self.append("1")), ("2", self.append("2")), ("3", self.append("3")), ("+", lambda: self.append("+")),
            ("()", lambda: self.append("()")), ("0", self.append("0")), (".", self.append(".")), ("=", self.equals)
        ]
    ...
    def append(self, char):
        ...
        elif re.search(r"01", self.formula):
            self.formula = self.formula[:-1]
        elif re.search(r"02", self.formula):
            self.formula = self.formula[:-1]
        elif re.search(r"03", self.formula):
            self.formula = self.formula[:-1]
        elif re.search(r"04", self.formula):
            self.formula = self.formula[:-1]
        elif re.search(r"05", self.formula):
            self.formula = self.formula[:-1]
        elif re.search(r"06", self.formula):
            self.formula = self.formula[:-1]
        elif re.search(r"07", self.formula):
            self.formula = self.formula[:-1]
        elif re.search(r"08", self.formula):
            self.formula = self.formula[:-1]
        elif re.search(r"09", self.formula):
            self.formula = self.formula[:-1]
