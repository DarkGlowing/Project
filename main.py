...
class Calculator:
    ...
    def append(self, char):
        ...
        try:
            if '0' in self.formula[-2:] and self.consecutive_zeros == True:
                pass
            elif '0' in self.formula[-2:] and self.consecutive_zeros == False:
                pass
        except:
            if '00' in self.formula[-2:] and self.consecutive_zeros == True:
                return
            elif '00' in self.formula[-2:] and self.consecutive_zeros == False:
                pass
