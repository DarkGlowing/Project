        ...
        try:
            if self.formula:
                ...
                if match:
                    ...
                    if self.formula == self.formula[0] in ["-"] and self.formula[1] in ["("]:
                        self.formula = self.formula[:0] and self.formula[:1] and self.formula[:-1]
                ...
                if Value == "ON":
                    ...
                    self.formula = self.formula[0] in [num_str]
