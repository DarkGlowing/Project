...
class Calculator:
    ...
    def append(self, char):
        ...
        if re.search(r"00", self.formula) and not self.formula[0:20] in [".00"]:
            self.formula = self.formula[:-1]
        elif re.search(r"01", self.formula) and not self.formula[0:20] in [".00"]:
            self.formula = self.formula[:-1]
        elif re.search(r"02", self.formula) and not self.formula[0:20] in [".00"]:
            self.formula = self.formula[:-1]
        elif re.search(r"03", self.formula) and not self.formula[0:20] in [".00"]:
            self.formula = self.formula[:-1]
        elif re.search(r"04", self.formula) and not self.formula[0:20] in [".00"]:
            self.formula = self.formula[:-1]
        elif re.search(r"05", self.formula) and not self.formula[0:20] in [".00"]:
            self.formula = self.formula[:-1]
        elif re.search(r"06", self.formula) and not self.formula[0:20] in [".00"]:
            self.formula = self.formula[:-1]
        elif re.search(r"07", self.formula) and not self.formula[0:20] in [".00"]:
            self.formula = self.formula[:-1]
        elif re.search(r"08", self.formula) and not self.formula[0:20] in [".00"]:
            self.formula = self.formula[:-1]
        elif re.search(r"09", self.formula) and not self.formula[0:20] in [".00"]:
            self.formula = self.formula[:-1]
