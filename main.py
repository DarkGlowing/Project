...
class Calculator:
    ...
    def zeros_confusion(self):
        if self.formula[2] in ["0"] and self.formula[3] in ["0"] or self.formula[3] in ["0"] and self.formula[4] in ["0"] or self.formula[6] in ["0"] and self.formula[7] in ["0"] or self.formula[9] in ["0"] and self.formula[10] in ["0"] or self.formula[12] in ["0"] and self.formula[13] in ["0"] or self.formula[15] in ["0"] and self.formula[16] in ["0"]:
            self.formula = self.formula[:-1]
            self.update_display()
            self.update_display(text=self.formula)
        elif self.formula[4] in ["0"] and self.formula[5] in ["0"] or self.formula[7] in ["0"] and self.formula[8] in ["0"] or self.formula[10] in ["0"] and self.formula[11] in ["0"] or self.formula[13] in ["0"] and self.formula[14] in ["0"] or self.formula[12] in ["0"] and self.formula[13] in ["0"] or self.formula[16] in ["0"] and self.formula[17] in ["0"]:
            self.formula = self.formula[:-1]
            self.update_display()
            self.update_display(text=self.formula)
        elif self.formula[5] in ["0"] and self.formula[6] in ["0"] or self.formula[8] in ["0"] and self.formula[9] in ["0"] or self.formula[11] in ["0"] and self.formula[12] in ["0"] or self.formula[14] in ["0"] and self.formula[15] in ["0"]:
            self.formula = self.formula[:-1]
            self.update_display()
            self.update_display(text=self.formula)
        elif self.formula[6] in ["0"] and self.formula[7] in ["0"] or self.formula[9] in ["0"] and self.formula[10] in ["0"] or self.formula[12] in ["0"] and self.formula[13] in ["0"] or self.formula[15] in ["0"] and self.formula[16] in ["0"]:
            self.formula = self.formula[:-1]
            self.update_display()
            self.update_display(text=self.formula)
        elif self.formula[7] in ["0"] and self.formula[8] in ["0"] or self.formula[10] in ["0"] and self.formula[11] in ["0"] or self.formula[13] in ["0"] and self.formula[14] in ["0"] or self.formula[16] in ["0"] and self.formula[17] in ["0"]:
            self.formula = self.formula[:-1]
            self.update_display()
            self.update_display(text=self.formula)
