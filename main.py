...
class Calculator:
    ...
    def consecutive_zeros(self):
        if self.formula[-2:] == "100":
            pass
        elif self.formula[-2:] == "200":
            pass
        elif self.formula[-2:] == "300":
            pass
        elif self.formula[-2:] == "400":
            pass
        elif self.formula[-2:] == "500":
            pass
        elif self.formula[-2:] == "600":
            pass
        elif self.formula[-2:] == "700":
            pass
        elif self.formula[-2:] == "800":
            pass
        elif self.formula[-2:] == "900":
            pass
        elif self.formula[-2:] == "00":
            self.formula == "0"
        self.display_update()
