...
class Calculator:
    ...
    def modul(self):
        ...
        if match:
            ...
            first_skobka = match.group(4)
            second_skobka = match.group(5)
            num2 = match.group(6)
            char = "+"
            print(num1)
            print(findchar)
            ...
            print(num2)
            print(second_skobka)
            if num1 and findchar and num2:
                self.formula = num1 + char + num2
            elif num1 and first_skobka and num2 and second_skobka:
                self.formula = num1 + char + skobka + num2 + self.formula
