...
class Calculator:
    ...
    def append(self, char):
        ...
        if self.consecutive_zeros == True:
            if '0' in self.formula[-2:]:
                pass
            elif '00' in self.formula[-2:]:
                self.formula = 0
                self.update_display()
        elif self.consecutive_zeros == False:
            if '0' in self.formula[-1:]:
                pass
            elif '00' in self.formula[-1:]:
                pass
