            ...
            if self.formula:
                ...
                if match:
                    ...
                    if match:
                        ...
                        elif self.formula[1] in ["-"] or self.formula[2] in ["-"] or self.formula[3] in ["-"] and self.formula["("]:
                            new_number_str = str(float(number-number))

                        if self.formula[1] in ["-"] or self.formula[2] in ["-"] or self.formula[3] in ["-"] and self.formula["("]:
                            new_number_str = str(int(number-number))
