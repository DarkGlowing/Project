...
class Calculator:
    def __init__(self, master):
        ...
        buttons = [
            ...
            ("()", lambda: self.append("()")), ("0", lambda: self.append("0")), (".", lambda: self.append(".")), ("=", self.equals), ("?", self.zeros_confusion)
        ]
    ...
    def zeros_confusion(self):
        print(self.formula[2] + self.formula[3])
        if self.formula[1] in ["+", "-", "/", "*"] and self.formula[2] in ["0"] and self.formula[3] in ["0"]:
            self.formula = self.formula[:2] and self.formula[:3]
            self.update_display()
            self.update_display(text=self.formula)
        elif self.formula[2] in ["+", "-", "/", "*"] and self.formula[3] in ["0"] and self.formula[4] in ["0"]:
            self.formula = self.formula[2]
            self.update_display()
            self.update_display(text=self.formula)
        elif self.formula[3] in ["+", "-", "/", "*"] and self.formula[4] in ["0"] and self.formula[5] in ["0"]:
            self.formula = self.formula[3]
            self.update_display()
            self.update_display(text=self.formula)
        elif self.formula[4] in ["+", "-", "/", "*"] and self.formula[5] in ["0"] and self.formula[6] in ["0"]:
            self.formula = self.formula[4]
            self.update_display()
            self.update_display(text=self.formula)
        elif self.formula[5] in ["+", "-", "/", "*"] and self.formula[6] in ["0"] and self.formula[7] in ["0"]:
            self.formula = self.formula[5]
            self.update_display()
            self.update_display(text=self.formula)
        elif self.formula[6] in ["+", "-", "/", "*"] and self.formula[7] in ["0"] and self.formula[8] in ["0"]:
            self.formula = self.formula[6]
            self.update_display()
            self.update_display(text=self.formula)
        elif self.formula[7] in ["+", "-", "/", "*"] and self.formula[8] in ["0"] and self.formula[9] in ["0"]:
            self.formula = self.formula[7]
            self.update_display()
            self.update_display(text=self.formula)
        elif self.formula[8] in ["+", "-", "/", "*"] and self.formula[9] in ["0"] and self.formula[10] in ["0"]:
            self.formula = self.formula[8]
            self.update_display()
            self.update_display(text=self.formula)
        elif self.formula[9] in ["+", "-", "/", "*"] and self.formula[10] in ["0"] and self.formula[11] in ["0"]:
            self.formula = self.formula[9]
            self.update_display()
            self.update_display(text=self.formula)
        elif self.formula[10] in ["+", "-", "/", "*"] and self.formula[11] in ["0"] and self.formula[12] in ["0"]:
            self.formula = self.formula[10]
            self.update_display()
            self.update_display(text=self.formula)
        elif self.formula[11] in ["+", "-", "/", "*"] and self.formula[12] in ["0"] and self.formula[13] in ["0"]:
            self.formula = self.formula[11]
            self.update_display()
            self.update_display(text=self.formula)
        elif self.formula[12] in ["+", "-", "/", "*"] and self.formula[13] in ["0"] and self.formula[14] in ["0"]:
            self.formula = self.formula[12]
            self.update_display()
            self.update_display(text=self.formula)
        elif self.formula[13] in ["+", "-", "/", "*"] and self.formula[14] in ["0"] and self.formula[15] in ["0"]:
            self.formula = self.formula[13]
            self.update_display()
            self.update_display(text=self.formula)
        elif self.formula[14] in ["+", "-", "/", "*"] and self.formula[15] in ["0"] and self.formula[16] in ["0"]:
            self.formula = self.formula[14]
            self.update_display()
            self.update_display(text=self.formula)
        elif self.formula[15] in ["+", "-", "/", "*"] and self.formula[16] in ["0"] and self.formula[17] in ["0"]:
            self.formula = self.formula[15]
            self.update_display()
            self.update_display(text=self.formula)
        elif self.formula[16] in ["+", "-", "/", "*"] and self.formula[17] in ["0"] and self.formula[18] in ["0"]:
            self.formula = self.formula[16]
            self.update_display()
            self.update_display(text=self.formula)
        elif self.formula[17] in ["+", "-", "/", "*"] and self.formula[18] in ["0"] and self.formula[19] in ["0"]:
